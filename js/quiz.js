...
const quizQuestions = [
  {
    id: 1,
    question: "How would you rate your overall Facebook experience?",
    options: [
  ...
  {
    id: 2,
    question: "What is your favorite video format on Facebook?",
    options: [
  ...
  {
    id: 3,
    question: "How do you discover new videos on Facebook?",
    options: [
  ...
  {
    id: 4,
    question: "How many hours per day do you spend on Facebook?",
    options: [
  ...
  {
    id: 5,
    question: "What makes you follow a creator on Facebook?",
    options: [
  ...
  {
    id: 6,
    question: "Which of these content themes do you most enjoy watching on Facebook?",
    options: [
      { emoji: "😂", text: "Comedy" },
      { emoji: "💃", text: "Dance" },
  ...
  {
    id: 7,
    question: "What time of day do you most use Facebook?",
    options: [
      { emoji: "🌅", text: "Morning" },
  ...
  {
    id: 8,
    question: "Which Facebook section do you access the most?",
    options: [
      { emoji: "🎯", text: "For You" },
  ...
  {
    id: 9,
    question: "How often do you comment on Facebook videos?",
    options: [
      { emoji: "🔄", text: "Always" },
  ...
  {
    id: 10,
    question: "What type of interaction do you most do on Facebook videos?",
    options: [
      { emoji: "👍", text: "Like" },
      { emoji: "💬", text: "Comment" },
      { emoji: "🔄", text: "Share" },
